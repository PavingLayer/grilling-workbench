...
function render() {
  ...
  app.innerHTML = `<div class="workspace">
    ...
    <div class="question-actions"><button class="text-button" data-action="defer">${draft.deferred ? 'Resume question' : 'Answer later'}</button>${hasAnswer(draft) ? '<button class="text-button" data-action="clear">Clear answer</button>' : ''}</div></article></main>
